...
2. Audit is mandatory: каждое изменение кейса порождает как минимум одно CaseEvent. Нет изменений без события.
...
8. Versioned workflow: workflow имеет версию; изменение workflow не должно ломать существующие кейсы без миграции/политики совместимости.